export const CONTROLLER_PREFIX_PATH = 'daruk:controller_prefix_path';
...
export const defineModulePrivateProperty = (property: string) =>
  `daruk:module_property_${property}`;
